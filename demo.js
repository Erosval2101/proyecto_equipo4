...
//__________________________________________________________________________________________________________________
function camara(){
	camera.position.set(6, player.height, -5);
...
function iluminacion(){
	...
	const light = new THREE.PointLight( 0x29d0fd, 75, 4 );
	light.position.z = -20.45;;
	light.position.x = -23.58;
	light.position.y = .5;

	const light2 = new THREE.PointLight( 0x29d0fd, 75, 4 );
	light2.position.z = -20.45;;
	light2.position.x = 23.2;
	light2.position.y = .5;

	const ligh3 = new THREE.PointLight( 0x29d0fd, 75, 4);
	ligh3.position.z = 20.45;;
	ligh3.position.x = -23.58;
	ligh3.position.y = .5;

	const light4 = new THREE.PointLight( 0x29d0fd, 75, 4);
